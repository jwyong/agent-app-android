...
import sg.com.agentapp.global.collapse_cal.CalendarAdapter;
import sg.com.agentapp.global.collapse_cal.Day;
import sg.com.agentapp.global.collapse_cal.Event;
import sg.com.agentapp.global.collapse_cal.view.ExpandIconView;

public class CollapsibleCalendar extends UICalendar {

    private CalendarAdapter mAdapter;
    private sg.com.agentapp.global.collapse_cal.widget.CollapsibleCalendar.CalendarListener mListener;
    ...
    protected void reload() {
        if (mAdapter != null) {
            ...
            for (int i = 0; i < 7; i++) {
                View view = mInflater.inflate(R.layout.layoutdayofweek, null);
