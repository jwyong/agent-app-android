package sg.com.agentapp.global.collapse_cal.view;
...
public class ExpandIconView extends View {
    ...
    @sg.com.agentapp.global.collapse_cal.view.ExpandIconView.State
    private int state;
     ...
     */
    public void setState(@sg.com.agentapp.global.collapse_cal.view.ExpandIconView.State int state, boolean animate) {
        this.state = state;
        if (state == MORE) {
            fraction = 0f;
        } else if (state == LESS) {
