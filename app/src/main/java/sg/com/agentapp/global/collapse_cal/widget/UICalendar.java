package sg.com.agentapp.global.collapse_cal.widget;
...
import sg.com.agentapp.global.collapse_cal.view.ExpandIconView;
import sg.com.agentapp.global.collapse_cal.view.LockScrollView;
...
public abstract class UICalendar extends LinearLayout {
    ...
    private Drawable mTodayItemBackgroundDrawable =
            getResources().getDrawable(R.drawable.bg_circle_black_stroke);
    private int mSelectedItemTextColor = Color.WHITE;
    private Drawable mSelectedItemBackgroundDrawable =
            getResources().getDrawable(R.drawable.bg_circle_black_solid);
    ...
    protected void init(Context context) {
        ...
        View rootView = mInflater.inflate(R.layout.widget_collapsiblecalendarview, this, true);
        ...
        expandIconView = rootView.findViewById(R.id.expandId);
